...
class DatabaseStats(BaseModel):
    ...
    clientes_unicos: Optional[int] = None
...
class SyncRequest(BaseModel):
    ...
    device_types: Optional[List[str]] = Field(None, description="Lista de tipos de dispositivo a sincronizar. Si es nulo, se sincronizan todos.")
